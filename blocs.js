...
export const TEMPLATES = {
  ...
  confiance_immediate: {
    id: "confiance_immediate",
    nom: "Confiance immédiate",
    pour: "Compléments, cosmétiques, santé et bien-être — quand la confiance décide de l'achat",
    description: "Hero → avis dès le début → bénéfices → démonstration → comparatif → offre entourée de réassurance → FAQ : la confiance s'installe avant même de détailler le produit.",
    theme: { fond: "blanc", police_titres: "sans", rayon: "doux", espacement: "aere" },
    blocs: [
      ["hero"],
      ["avis"],
      ["benefices", { titre: "Ce qu'il change pour vous", colonnes: "3" }],
      ["comment_ca_marche"],
      ["video"],
      ["comparaison"],
      ["offres"],
